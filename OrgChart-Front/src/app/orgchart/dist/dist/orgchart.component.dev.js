...
function () {
            ...
            var empTable = $('#empTable').DataTable({
              ...
              ajax: {
                ...
                dataSrc: function dataSrc(json) {
                  json = JSON.parse(JSON.stringify(json).replace(/\s(?=\w+":)/g, "")); //data = org , x.dept = employee

                  var findemp = json.filter(function (x) {
                    return x.deptCode == data.deptCode;
                  });
  ...
  OrgchartComponent = __decorate([core_1.Component({
...
exports.OrgchartComponent = OrgchartComponent; // imgSource : {row.eM_CODE.toString().substring(row.eM_CODE.toString().length - 4)}.jpg" class="backup_picture img-fluid rounded-start" onerror=this.src="/assets/images/icons8-user-100.png">
//# sourceMappingURL=orgchart.component.dev.js.map
